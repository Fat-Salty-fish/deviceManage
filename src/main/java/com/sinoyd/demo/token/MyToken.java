...
public class MyToken {
    ...
    public static String createJWT(UserInfo userInfo, long ttlMillis){      //新建token 需要用户信息 将用户信息传入以用来生成Token
    ...
    public static Claims parseJWT(String token) {  //用来解析token
